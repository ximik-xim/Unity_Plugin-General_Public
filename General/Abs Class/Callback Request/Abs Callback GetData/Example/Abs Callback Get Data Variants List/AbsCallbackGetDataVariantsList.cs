...
/// </summary>
[System.Serializable]
public class AbsCallbackGetDataVariantsList<AbsCallbackGet, GetType, ArgData>
    where AbsCallbackGet : AbsCallbackGetData<GetType, ArgData> 
{
    ...
    public GetServerRequestData<GetType> GetData(ArgData data)
    {
        ...
        CallbackRequestDataWrapperT<GetType> wrapperCallbackData = new CallbackRequestDataWrapperT<GetType>(id);
        _idCallback.Add(id);
        ...
        if (_variants.Count > 0)
        {
            ...
            void NextElement()
            {
                if (_variants.Count >= lastId + 1)
                {
                    ...
                    var dataCallback = requestData.GetData(data);
