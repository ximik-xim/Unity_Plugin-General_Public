...
/// </summary>
[System.Serializable]
public class AbsCallbackGetDataCheckIsGet<AbsCallbackGet, GetType, ArgData, CheckBool>
    ...
    where CheckBool : AbsRequestDataBoolIsGetObject<ArgData>
{
    ...
    {
        int id = GetUniqueId();
        CallbackRequestDataWrapperT<GetType> callbackData = new CallbackRequestDataWrapperT<GetType>(id);
        _idCallback.Add(id);
        ...
        void StartGetData()
        {
            ...
            var callbackGetData = _absGetData.GetData(data);
